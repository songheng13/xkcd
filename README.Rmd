...
The `xkcd` package provides an R interface to retrieve data about [xkcd_comic](https://xkcd.com) from the xkcd JSON API. Most importantly, you can view these comics in the RStudio plot window
